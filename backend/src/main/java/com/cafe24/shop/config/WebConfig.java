...
@Import({MVCConfig.class, MessageConfig.class,SwaggerConfig.class,FileuploadConfig.class,SecurityConfig.class})//SecurityConfig.class,FileuploadConfig.class
