...
@Import({MVCConfig.class, MessageConfig.class,SwaggerConfig.class,FileuploadConfig.class,SecurityConfig.class})//ResourceServerConfig.class,AuthorizationServerConfig.class
